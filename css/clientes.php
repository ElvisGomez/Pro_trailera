      ...
      <div class="box box-info">
            ...
            <form class="form-horizontal" method="POST" action="logica/Registroclientes.php" >
              <div class="box-body">
                ...
                <label for="inputEmail3" class="col-sm-2 control-label" style="text-align:right;">Nombre Compañia</label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control" name="nombre" placeholder="Nombre Cliente" required pattern="[a-zA-Z ñáéíóú.]*">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="direccion" id="direccion_Cliente" placeholder="#Casa Calle Municipio País" required><br>
                ...
                <div class="form-group">
                 ...
                 <div id="map" class="box fluid" style=" height: 75vh; width: 100%;align-content: center">
              ...
              name="limpiar" title="Guardar"><span> Limpiar <i class="fa fa-eraser" aria-hidden="true"></i>
                ...
                name="guardar" title="Guardar" ><span> Guardar <i class="fa fa-floppy-o" aria-hidden="true"></i>
                </span></button>
              </div>
...
<section class="content-header">      
  <div class="row">
        <div class="col-xs-12">
          ...
          $q = "SELECT id_Cliente,nombre_Cliente,telefono_Cliente,email_Cliente,direccion_Cliente FROM cliente";
