...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    <section class="content-header">
            ...
            <div class="box-body">
            <form class="form-horizontal" method="POST" action="logica/Modificarusuario.php" autocomplete="off">
                ...
                <div class="form-group">
                  <div class="col-sm-10"><input type="hidden" class="form-control" name="id" placeholder="ID"  required pattern="[a-zA-Z ñáéíóú]*" value="<?php echo $res['id_usuario']; ?>"> </div>
                </div>


                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label" style="text-align:right;" >Nombre</label>
                  <div class="col-sm-10"><input type="text" class="form-control" name="nombre" placeholder="Ingrese Nombre"  required pattern="[a-zA-Z ñáéíóú]*" value="<?php echo $res['nombre']; ?>"> </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10"><input type="text" class="form-control" name="apellido" placeholder="Ingrese Apellido" required pattern="[a-zA-Z ñáéíóú]*" value="<?php echo $res['apellido']; ?>"> </div>
                </div>


                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label" style="text-align:right;">Usuario</label>
                  <div class="col-sm-10"><input type="text" class="form-control" name="usuario" placeholder="Usuario" required pattern="[a-zA-Z ñáéíóú 0-9]*" value="<?php echo $res['usuario']; ?>"></div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10"><input type="email" class="form-control"  name="correo" placeholder="Correo" required pattern="[a-z0-9_]+([.][a-z0-9_]+)*@[a-z0-9_]+([.][a-z0-9_]+)*[.][a-z]{1,5}"  value="<?php echo $res['correo']; ?>" ></div>
                </div>
