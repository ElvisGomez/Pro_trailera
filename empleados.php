    ...
    <div class="pull-left info">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class=""><a href="clientes.php"><i class="fa fa-user"></i> <span>Registro de cliente</span></a></li>
         <li class="active"><a href="empleados.php"><i class="fa fa-male"></i> <span>Registro de motoristas</span></a></li>
           ...
           <div class="box box-widget collapsed-box">
            <div class="box-header with-border">
              <div class="user-block">
                <img class="img-circle" src="../Pro_trailera/dist/img/user3-128x128.png" alt="User Image">
                <span class="username"><a href="#">Registro Motoristas</a></span>
              </div>
              <div class="box-tools">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus">AGREGAR MOTORISTA</i>
                </button>
            ...
            <form class="form-horizontal" action="logica/Registromotorista.php" method="POST">
              <div class="box-body">

                <div class="form-group">
        <label for="inputEmail3" class="col-sm-2 control-label" style="text-align:right;">Nombre</label>
                  <div class="col-sm-10"><input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre Motorista" required pattern="[a-zA-Z ñáéíóú]*"></div>
                </div>


                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label" style="text-align:right;">Apellidos</label>
                  <div class="col-sm-10"><input type="text" class="form-control" id="apellidos" name="apellido" placeholder="Apellidos Motorista" required pattern="[a-zA-Z ñáéíóú]*"> </div>
                </div>

                 <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label" style="text-align:right;">Dui</label>
                  <div class="col-sm-10"><input type="text" class="form-control" id="apellidos" name="dui" placeholder="#########-#" require pattern="[0-9]{8}-[0-9]{1}"> </div>
                </div>


                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label" style="text-align:right;">Telefono</label>
                  <div class="col-sm-10"><input type="text" class="form-control" id="telefono" name="telefono" placeholder="####-####" required pattern="[0-9]{4}-[0-9]{4}"></div>
                </div>


                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label" style="text-align:right;">Dirección</label>
                  <div class="col-sm-10"><input type="text" class="form-control" id="direccion" name="direccion" placeholder="Ingrese la dirección" required></div>
                </div>


                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label" style="text-align: right;">Genero</label>
                  <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10"><input type="text" class="form-control" id="dui" name="correo" placeholder="Ingrese el correo electronico" required></div>
                </div>
        ...
        <div class="col-xs-12 ">
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                <div class="input-group input-group-sm col-sm-10" style="width: 150px; ">
          ...
          $q = "SELECT id_Motorista,nombre_motorista,apellido_motorista,dui_motorista,telefono_motorista,direccion_motorista,genero_motorista,correo_motorista FROM motorista";
          $query = mysqli_query($conexion,$q);
          ...
          ?>  
           <tr>
                  ...
                  <td><?php echo $res['nombre_motorista']; ?></td>
                  <td><?php echo $res['apellido_motorista']; ?></td>
                  <td><?php echo $res['dui_motorista']; ?></td>
                  <td><?php echo $res['telefono_motorista']; ?></td>
                  <td><?php echo $res['direccion_motorista']; ?></td>
                  <td><?php echo $res['correo_motorista']; ?></td>
                  <td><?php echo $res['genero_motorista']; ?></td>
                  
                  <td>
                  


                  <a href="modificarmotorista.php?id=<?php echo $res['id_Motorista']?>">
                  ...
                  <a href="#" data-href="logica/Eliminarmotoris.php?id=<?php echo $res['id_Motorista']?>" onclick="prueba(<?php echo $res['id_Motorista']?>)">
                  <button type="submit" class="btn btn-danger btn-sm" name="eliminar" style="margin: 3px;" title="Eliminar">
                  <i class="fa fa-trash-o" style="font-size: 150%;"></i><h style="font-family: Arial"> Eliminar</h></button></a>
 ...
 <div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <script>
      function prueba(id){
        ...
        $('#linkdelete').attr('href', 'logica/Eliminarmotoris.php?id='+ id);
